...
$COMPOSE exec -T postgres psql -U quant_research -d quant_research < services/quant-research-service/migrations/003_daily_analysis.sql
$COMPOSE exec -T postgres psql -U quant_research -d quant_research < services/quant-research-service/migrations/004_strategy_runs.sql
