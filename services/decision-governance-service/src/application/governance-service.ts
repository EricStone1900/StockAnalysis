...
export class GovernanceService {
  public constructor(private readonly aggregate = new ProposalAggregate(), private readonly repository?: PostgresProposalRepository, private readonly budget = new DecisionBudgetReservation(), private readonly budgetRepository?: PostgresBudgetRepository) {}
  ...
  public async releaseBudget(reservationId: string): Promise<Reservation> { const reservation = this.budget.release(reservationId); await this.budgetRepository?.release(reservationId); return reservation; }
}
