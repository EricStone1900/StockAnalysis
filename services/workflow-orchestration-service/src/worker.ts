...
import { FakeDailyQuantActivities, FakeInvestmentDecisionActivities, FakeMarketMonitorActivities, FakeMarketRegimeActivities, FakeNewsAnalysisActivities, FakeWorkflowActivities } from './activities/fake-activities.js';
