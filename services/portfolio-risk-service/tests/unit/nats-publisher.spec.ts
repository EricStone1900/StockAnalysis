...
describe('NatsJetStreamPublisher', () => {
  it('以事件主题和 JSON payload 发布到 JetStream', async () => {
    ...
    await publisher.publish({ eventId: 'event-1', subject: 'stock.portfolio-risk.risk-evaluation.created.v1', aggregateId: 'p-1', payload: { evaluation: { verdict: 'PASS' } }, availableAt: '2026-09-04T00:00:00Z' });
