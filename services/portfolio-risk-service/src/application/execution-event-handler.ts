...
export class ExecutionEventHandler {
  ...
  constructor(private readonly portfolios: Pick<PortfolioService, 'latest' | 'recordConfirmedFill'>, private readonly resources: Pick<ResourceReservationService, 'transition'>) {}
