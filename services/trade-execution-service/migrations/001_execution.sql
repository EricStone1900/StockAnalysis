...
CREATE TABLE IF NOT EXISTS execution_outbox_events (event_id TEXT PRIMARY KEY, subject TEXT NOT NULL, aggregate_id TEXT NOT NULL, payload JSONB NOT NULL, available_at TIMESTAMPTZ NOT NULL, published_at TIMESTAMPTZ, created_at TIMESTAMPTZ NOT NULL DEFAULT now());
